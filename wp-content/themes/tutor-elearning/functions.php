...
add_action('wp_ajax_check_plugin_activation', function () {
    ...
    $tutor_elearning_plugin_map = [
        'woocommerce'          => 'woocommerce/woocommerce.php',
        'wordclever_ai_content_writer'    => 'wordclever-ai-content-writer/wordclever.php',
    ];

    $tutor_elearning_requested_plugin = sanitize_text_field($_POST['plugin']);

    if (!isset($tutor_elearning_plugin_map[$tutor_elearning_requested_plugin])) {
        wp_send_json_error(['message' => 'Invalid plugin']);
    }

    $tutor_elearning_plugin_file = $tutor_elearning_plugin_map[$tutor_elearning_requested_plugin];
    $tutor_elearning_is_active   = is_plugin_active($tutor_elearning_plugin_file);

    wp_send_json_success(['active' => $tutor_elearning_is_active]);
});
