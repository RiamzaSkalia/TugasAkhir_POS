...
function tutor_elearning_do_admin_page() {
	...
	<div class="tutor-elearning-appearence wrap about-wrap">
		<div class="head-btn">
         ...
         <span>
					<a class="button btn-bundle" href="<?php echo esc_url( TUTOR_ELEARNING_BUY_BUNDLE ); ?>" target="_blank"><?php esc_html_e( 'Buy Bundle', 'tutor-elearning' ); ?></a>
				</span>
				<span>
		...
		<div class="two-col">
         ...
         <p>
			    <a class="button button-primary" href="<?php echo esc_url( home_url() ); ?>" target="_blank"><?php esc_html_e( 'Visit Site', 'tutor-elearning' ); ?></a>
			    <a class="button button-primary" id="form-button" href="<?php echo esc_url( 'https://forms.gle/RhBK4jcPYRm1z38N6' ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Free Theme Installation Support', 'tutor-elearning' ); ?></a>
		    </p>
			</div><!-- .col -->
...
<div class="col">
		...
		<h3><i class="dashicons dashicons-visibility"></i><?php esc_html_e( 'Live Demo', 'tutor-elearning' ); ?></h3>

		<p>
			<?php esc_html_e( 'Preview the live demo to explore the homepage, inner pages, and overall design flow before setup.', 'tutor-elearning' ); ?>
		</p>

		<p>
			<a class="button button-primary" href="<?php echo esc_url( TUTOR_ELEARNING_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e( 'View Live Demo', 'tutor-elearning' ); ?></a>
		</p>
	...
	<div class="col">
			<h3>
				...
				<?php esc_html_e( 'Quick Link', 'tutor-elearning' ); ?>
			</h3>

			<div class="tutor-elearning-card-body">
				<div class="tutor-elearning-card-btn-grp">
