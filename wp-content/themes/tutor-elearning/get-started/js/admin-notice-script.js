...
document.addEventListener('DOMContentLoaded', function () {
    ...
    tutor_elearning_button.addEventListener('click', function (e) {
        ...
        tutor_elearning_checkData.append('action', 'check_plugin_activation');
        ...
        .then(res => {
            if (res.success && res.data.active) {
                ...
                tutor_elearning_installData.append('action', 'install_and_activate_required_plugin');
                tutor_elearning_installData.append('_ajax_nonce', installPluginData.nonce);
