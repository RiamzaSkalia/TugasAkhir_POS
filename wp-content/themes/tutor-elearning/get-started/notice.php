        ...
        <div class="updated notice notice-success is-dismissible notice-get-started-class" data-notice="get-start" style="display: flex;padding: 10px;">
        		<div class="notice-content">
	        		<div class="notice-holder">
	                        ...
	                        <a href="<?php echo esc_url( 'https://forms.gle/RhBK4jcPYRm1z38N6' ); ?>" target="_blank" rel="noopener noreferrer" id="form-button" class="button admin-button installation-form-button"><?php echo esc_html__( 'Free Theme Installation Support', 'tutor-elearning' ); ?></a>
