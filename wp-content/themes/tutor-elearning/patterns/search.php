 ...
 * Search Section
 * 
 * slug: tutor-elearning/search-page
 * title: Search Page
 * categories: tutor-elearning
 */

return array(
    'title'      =>__( 'Search Page', 'tutor-elearning' ),
...
<h2 class="wp-block-heading has-text-align-center"> '. esc_html__('No results found','tutor-elearning') .'</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"> '. esc_html__('We could not find any posts matching your search. Try different keywords.','tutor-elearning') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"tutor-elearning","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
